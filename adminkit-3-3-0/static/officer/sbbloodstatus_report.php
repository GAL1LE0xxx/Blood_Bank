...
<head>
    ...
    <title>รายงานข้อมูลโลหิตเฉพาะส่วน</title>
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3"><strong>รายงานข้อมูลโลหิตเฉพาะส่วน</strong></h1>
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        if (isset($_GET['month']) && isset($_GET['year'])) {
                                            ...
                                            // คำสั่ง SQL เริ่มต้น
                                            $query = "SELECT COUNT(*) as total FROM specificdonation WHERE sd_status = 0 
                      ...
                      AND YEAR(sd_date) = $selectedYear";
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) as total FROM specificdonation WHERE sd_status = 2 
                      AND MONTH(sd_date) = $selectedMonth 
                      AND YEAR(sd_date) = $selectedYear";
                        } else {
                            // ถ้าไม่มีการเลือกเดือนหรือปี
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) as total FROM specificdonation WHERE sd_status = 1 
                      AND MONTH(sd_date) = $selectedMonth 
                      AND YEAR(sd_date) = $selectedYear";
                        } else {
                            // ถ้าไม่มีการเลือกเดือนหรือปี
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card flex-fill w-150">
                            <div class="card-header">
                                <h5 class="card-title mb-0">แผนภูมิแท่งแสดงข้อมูลสถานะโลหิตเฉพาะส่วน
                                    <?php
                                    if (isset($_GET['month']) && isset($_GET['year'])) {
                                        $selectedMonth = $_GET['month'];
                                        $selectedYear = $_GET['year'];
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new Chart(document.getElementById("chartjs-dashboard-bar"), {
                type: "bar",
                data: {
                    labels: ['ข้อมูลสถานะโลหิตเฉพาะส่วน'],
                    datasets: [{
