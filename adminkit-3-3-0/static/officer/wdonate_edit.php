...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT wholedonation.*, donor.dn_name 
            FROM wholedonation 
            JOIN donor ON wholedonation.dn_id = donor.dn_id 
            WHERE wholedonation.wd_id = $id";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);

    if ($row) {
        $donateday = $row['wd_date'];
                                        ...
                                        <div class="contentdata ">
                                            ...
                                            <div class="m-sm-4">
                                                <form action="wdonate_edit_db.php" method="post">
                                                    ...
                                                    <button type="submit" class='btn btn-success' name="edit_wdonate">ยืนยัน</button>
