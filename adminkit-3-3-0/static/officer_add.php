                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="index.php">
                            <i class="align-middle" data-feather="user-plus"></i> <span
                                class="align-middle">จัดการข้อมูลเจ้าหน้าที่</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="pages-profile.html">
                            <i class="align-middle" data-feather="user"></i> <span
                                class="align-middle">จัดการข้อมูลโลหิต</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="pages-profile.html">
                            <i class="align-middle" data-feather="compass"></i> <span
                                class="align-middle">จัดการข้อมูลประชาสัมพันธ์</span>
                        </a>
                    </li>
                                            ...
                                            <form action="officer_add_db.php" method="post">
                                                <div class="card-body ">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control " name="oc_username"
                                                            required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h5 class="card-title mb-3">รหัสผ่าน</h5>
                                                        <input type="password" class="form-control " name="oc_password"
                                                            required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h5 class="card-title mb-3">ยืนยันรหัสผ่าน</h5>
                                                        <input type="password" class="form-control " name="oc_password2"
                                                            required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h5 class="card-title mb-3">ชื่อ</h5>
                                                        <input type="text" class="form-control " name="oc_firstname"
                                                            required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h5 class="card-title mb-3">สกุล</h5>
                                                        <input type="text" class="form-control " name="oc_lastname"
                                                            required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <h5 class="card-title mb-3">เบอร์โทรศัพท์</h5>
                                                        <input type="text" class="form-control " name="oc_phonenumber"
                                                            required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-check">
                                                            <input class="form-check-input" type="radio" id="admin"
                                                                name="oc_position" value="0" required>
                                                        ...
                                                        <label class="form-check">
                                                            <input class="form-check-input" type="radio" id="mt"
                                                                name="oc_position" value="1"> <span
                                                    ...
                                                    <button type="submit" class='btn btn-success'
                                                        name="add_officer">ยืนยัน</button>
                        ...
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://adminkit.io/"
                                    target="_blank"><strong>ธนาคารเลือด</strong></a> - <a class="text-muted"
                                    href="https://adminkit.io/" target="_blank"><strong>โรงพยาบาลตรัง</strong></a>
                                &copy;
                            </p>
                        </div>
