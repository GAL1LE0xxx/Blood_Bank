                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col d-flex justify-content-center">
                                    <a href="../home.php" class="btn btn-outline-danger btn-lg btn-block square-btn">
                                        <i class="fas fa-home square-icon"></i>
                                        <span class="mt-3" style="font-size: larger;">หน้าหลัก</span>
                                    </a>
                                </div>
                                <div class="col d-flex justify-content-center">
                                    <a href="adminprofile.php" class="btn btn-outline-danger btn-lg btn-block square-btn">
                                        <i class="fas fa-solid fa-user square-icon"></i>
                                        <span class="mt-3" style="font-size: larger;">บัญชีผู้ใช้</span>
                                    </a>
                                </div>
                                <div class="col d-flex justify-content-center">
                                    <a href="officer.php" class="btn btn-outline-danger btn-lg btn-block square-btn">
                                        <i class="fas fa-solid fa-user-plus square-icon"></i>
                                        <span class="mt-3" style="font-size: larger;">จัดการข้อมูลเจ้าหน้าที่</span>
                                    </a>
                                </div>
                                <div class="col d-flex justify-content-center">
                                    <a href="blood.php" class="btn btn-outline-danger btn-lg btn-block square-btn">
                                        <i class="fas fa-droplet square-icon"></i>
                                        <span class="mt-3" style="font-size: larger;">จัดการข้อมูลโลหิต</span>
                                    </a>
                                </div>
                            </div>
                            <div class="row mt-3">
