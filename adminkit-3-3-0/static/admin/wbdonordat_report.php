...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3"><strong>รายงานข้อมูลและจำนวนผู้บริจาคโลหิต (แยกตามประเภทของโลหิตรวม)</strong></h1>
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        if (isset($_GET['month']) && isset($_GET['year'])) {
                                            ...
                                            // คำสั่ง SQL เริ่มต้น
                                            $query = "SELECT COUNT(*) as total FROM wholedonation 
                                            WHERE MONTH(wd_date) = $selectedMonth AND YEAR(wd_date) = $selectedYear";
                                    ...
                                    <h1 class="mt-1 mb-3"><?php echo $wbdonor ?> คน </h1>
                                </div>
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) AS total_donorsA
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">จำนวนผู้บริจาคโลหิตหมู่เลือด A </h5>
                                        </div>

                                        <div class="col-auto">
                                            <div class="stat text-danger">
                                                A<i class="bi bi-person-fill"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3"><?php echo $total_donorsA ?> คน </h1>
                                </div>
                            </div>
                        </div>
                        <!-- A -->
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) AS total_donorsB
                            FROM wholedonation wh
                            INNER JOIN donor d ON wh.dn_id = d.dn_id
                            INNER JOIN wholeblood wb ON d.wb_id = wb.wb_id
                            WHERE wb.wb_id = 2
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">จำนวนผู้บริจาคโลหิตหมู่เลือด B </h5>
                                        </div>

                                        <div class="col-auto">
                                            <div class="stat text-danger">
                                                B<i class="bi bi-person-fill"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3"><?php echo $total_donorsB ?> คน </h1>
                                </div>
                            </div>
                        </div>
                        <!-- B -->
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) AS total_donorsO
                            FROM wholedonation wh
                            INNER JOIN donor d ON wh.dn_id = d.dn_id
                            INNER JOIN wholeblood wb ON d.wb_id = wb.wb_id
                            WHERE wb.wb_id = 3
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">จำนวนผู้บริจาคโลหิตหมู่เลือด O </h5>
                                        </div>

                                        <div class="col-auto">
                                            <div class="stat text-danger">
                                                O<i class="bi bi-person-fill"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3"><?php echo $total_donorsO ?> คน </h1>
                                </div>
                            </div>
                        </div>
                        <!-- O -->
                        ...
                        if (isset($_GET['month']) && isset($_GET['year'])) {
                            ...
                            // คำสั่ง SQL เริ่มต้น
                            $query = "SELECT COUNT(*) AS total_donorsAB
                            FROM wholedonation wh
                            INNER JOIN donor d ON wh.dn_id = d.dn_id
                            INNER JOIN wholeblood wb ON d.wb_id = wb.wb_id
                            WHERE wb.wb_id = 3
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">จำนวนผู้บริจาคโลหิตหมู่เลือด AB </h5>
                                        </div>

                                        <div class="col-auto">
                                            <div class="stat text-danger">
                                                AB<i class="bi bi-person-fill"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3"><?php echo $total_donorsAB ?> คน </h1>
                                </div>
                            </div>
                        </div>
                        <!-- AB -->
    ...
    <?php
    $data = array(
        "total_donorsA" => $total_donorsA,
        "total_donorsB" => $total_donorsB,
        "total_donorsO" => $total_donorsO,
        "total_donorsAB" => $total_donorsAB,
    );
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var total_donorsA = jsonData.total_donorsA;
            var total_donorsB = jsonData.total_donorsB;
            var total_donorsO = jsonData.total_donorsO;
            var total_donorsAB = jsonData.total_donorsAB;
            ...
            new Chart(document.getElementById("chartjs-dashboard-bar"), {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'จำนวนผู้บริจาคโลหิตหมู่เลือด A',
                            data: [total_donorsA],
                        ...
                        {
                            label: 'จำนวนผู้บริจาคโลหิตหมู่เลือด B',
                            data: [total_donorsB],
                        ...
                        {
                            label: 'จำนวนผู้บริจาคโลหิตหมู่เลือด O',
                            data: [total_donorsO],
                        ...
                        {
                            label: 'จำนวนผู้บริจาคโลหิตหมู่เลือด AB',
                            data: [total_donorsAB],
