        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"><strong>รายงานข้อมูลและจํานวนผู้บริจาคโลหิต</strong> ประเภทโลหิตรวม</h1>
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">จำนวนผู้บริจาคโลหิตทั้งหมด</h5>
                                        </div>
